...
//   const { about, firstName, lastName, photoUrl, skills, status } = request.fromUserId;
//   console.log({
//     about,
//     firstName,
//     lastName,
...
return (
        ...
        { age &&<p className="text-gray-500 text-sm mt-1">Age: {age+ "," +gender}</p>}
              ...
              <div>
                ...
                <button className="mx-5 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-700 transition">
                  Reject
                </button>
              </div>
            </div>
